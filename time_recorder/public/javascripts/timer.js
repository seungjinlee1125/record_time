(function() {
  ...
  setAttributes = function() {
    ...
    if (seconds < 10) {
      ...
      return $('.js-clock[data-dur="s"]').attr(
        "data-cur",
        nthDigit(seconds, 1) + 1
      );
    }
  };
  ...
  appendEls = function() {
    return $(".js-clock").each(function() {
      ...
      while (k <= end) {
        ...
        $el.append(
          '<div class="dial"><span>' + k + "</span><span>" + l + "</span>"
        );
        k++;
      }
      $el.prepend('<div class="dial"><span>0</span><span>0</span></div>');
      $el.append(
        '<div class="dial dial--last"><span>0</span><span>0</span></div>'
      );
  ...
  attachEvents = function() {
    ...
    $(document).on("10m", function() {
      return tick($('.js-clock[data-dur="mm"]'));
    });
